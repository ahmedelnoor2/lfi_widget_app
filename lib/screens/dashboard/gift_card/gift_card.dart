...
class _GiftCardState extends State<GiftCard> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          title: giftcardprovider.toActiveCountry['name'] ==
                                  null
                              ? Container()
                              : Text(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: giftcardprovider.sliderlist
                        .asMap()
                        .entries
                        .map((entry) {
    ...
    child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Text('BETA',style: TextStyle(fontSize: 10,color: Colors.red),),
        Text('Version',style: TextStyle(fontSize:8,color: Colors.white)),
      ],
    ),
          ));
