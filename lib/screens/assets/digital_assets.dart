                        ...
                        child: Text(
                          getNumberFormat(
                            ...
                            public.rate[public.activeCurrency['fiat_symbol']
                                    ...
                                    null
                                ? '${double.parse(widget.totalBalance ?? '0') * public.rate[public.activeCurrency['fiat_symbol'].toUpperCase()][widget.totalBalanceSymbol]}'
                                : '0',
                          ),
                          style: TextStyle(
                            color: secondaryTextColor,
                                        ...
                                        Text(
                                          getNumberFormat(
                                            ...
                                            public.rate[
                                                        ...
                                                        .totalBalanceSymbol] !=
                                                    null
                                                ? '${double.parse(asset['values']['total_balance'] ?? '0') * public.rate[public.activeCurrency['fiat_symbol'].toUpperCase()][asset['coin']]}'
                                                : '0',
                                          ),
                                          style: TextStyle(
                                            fontSize: width * 0.035,
                                        ...
                                        Text(
                                          getNumberFormat(
                                            ...
                                            public.rate[
                                                        ...
                                                        .totalBalanceSymbol] !=
                                                    null
                                                ? '${(asset['values']['present_coin_balance'] ?? 0) * public.rate[public.activeCurrency['fiat_symbol'].toUpperCase()][asset['coin']]}'
                                                : '0',
                                          ),
                                          style: TextStyle(
                                            fontSize: width * 0.035,
                                        ...
                                        Text(
                                          getNumberFormat(
                                            ...
                                            public.rate[
                                                        ...
                                                        .totalBalanceSymbol] !=
                                                    null
                                                ? '${double.parse(asset['values']['lock_balance'] ?? '0') * public.rate[public.activeCurrency['fiat_symbol'].toUpperCase()][asset['coin']]}'
                                                : '0',
                                          ),
                                          style: TextStyle(
                                            fontSize: width * 0.035,
